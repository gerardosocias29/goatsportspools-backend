...
use App\Mail\CommissionerApplicationReceivedMail;
...
class SquaresAdminApplicationController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            Mail::to($application->email)->send(new CommissionerApplicationReceivedMail($application));
            \Log::info("Sent confirmation email to applicant: {$application->email}");
        } catch (\Exception $e) {
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->status === 'approved') {
            ...
            try {
                ...
                \Log::info("Sent approval email to: {$application->email}");
            } catch (\Exception $e) {
            ...
            try {
                ...
                \Log::info("Sent denial email to: {$application->email}");
            } catch (\Exception $e) {
